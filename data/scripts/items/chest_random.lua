...
function drop_random_reward( x, y, entity_id, rand_x, rand_y, set_rnd_  )
	...
	while( count > 0 ) do -- 0
		...
		elseif( rnd <= 54 ) then
			-------------------------------------------------------------------
			-- Sausage (was spell refresh before)
			-------------------------------------------------------------------
			table.insert( entities, { "data/entities/projectiles/deck/sausage.xml" } )
		
		elseif( rnd <= 60 ) then -- 60
			-------------------------------------------------------------------
			-- Misc items
			-------------------------------------------------------------------
